		...
		private static readonly Dictionary<int, MobData> mobs = new Dictionary<int, MobData>()
			{
				...
				{ 7265, new MobData { Threat=MobData.ThreatLevel.Danger, Aggro=MobData.AggroType.Proximity, IsStunnable=false, MobNotes="Triple auto inflicts Bleed" } },
				...
				// HoH floors 11-19
                { 7275, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="" } },
				{ 7276, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Proximity, IsStunnable=null, MobNotes="" } },
				{ 7277, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="" } },
				{ 7278, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="" } },
				{ 7279, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="Lite buster \"Scissor Run\" followed by AoE" } },
				{ 7280, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="" } },
				{ 7281, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="Gaze inflicts Seduce, followed by large AoE that inflicts Minimum" } },
				{ 7282, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="" } },
				{ 7283, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="" } },
				{ 7284, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="" } },
				{ 7285, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="Buster and triple auto" } },
				{ 7286, new MobData { Threat=MobData.ThreatLevel.Danger, Aggro=MobData.AggroType.Proximity, IsStunnable=null, MobNotes="Roomwide ENRAGE" } },
				{ 7287, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="" } },
				// HoH floors 21-29
                { 7288, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Proximity, IsStunnable=null, MobNotes="Gaze inflicts Blind" } },
				...
				{ 7293, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="" } },
				{ 7294, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="" } },
				{ 7295, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="Draw-in followed by cleave" } },
				{ 7296, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="Gaze" } },
				{ 7297, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Proximity, IsStunnable=null, MobNotes="Line AoE inflicts Bleed" } },
				{ 7298, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="Cross AoE inflicts Suppuration" } },
				{ 7299, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="Large AoE inflicts Paralysis" } },
				{ 7300, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="Circle AoE inflicts Suppuration" } },
				...
				//HoH floors 31-39
                { 7303, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="Double auto inflicts Bleed\nLow health ENRAGE" } },
				{ 7304, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="Low health ENRAGE" } },
				...
				{ 7306, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="Cleaves every other auto" } },
				{ 7307, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="" } },
				{ 7308, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="Weak stack attack" } },
				{ 7309, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="" } },
				...
				{ 7311, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="Line AoE inflicts Bleed\nLow health ENRAGE" } },
				{ 7312, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="Frontal cleave without cast or telegraph" } },
				{ 7313, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Proximity, IsStunnable=null, MobNotes="Gaze inflicts Otter" } },
				// HoH floors 41-49
                { 7314, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="Casts AoEs unaggroed" } },
				{ 7315, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="" } },
				{ 7316, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="" } },
				{ 7317, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="" } },
				{ 7318, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="Large line AoE\nEventual ENRAGE" } },
				{ 7319, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="Casts AoEs unaggroed" } },
				{ 7320, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="Purple: double auto" } },
				{ 7321, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="Large cone AoE" } },
				{ 7322, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="" } },
				{ 7323, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="Green: Casts AoEs unaggroed" } },
				{ 7324, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="Very wide line AoE" } },
				{ 7325, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="" } },
				{ 7326, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Sound, IsStunnable=null, MobNotes="Eventual ENRAGE" } },
				//HoH floors 51-59
				...
				{ 7334, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="" } },
				{ 7335, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="Draw-in attack" } },
				...
				// HoH floors 61-69
                { 7340, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Proximity, IsStunnable=null, MobNotes="Inflicts stacking Poison that lasts 30s" } },
				...
				{ 7344, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sound, IsStunnable=null, MobNotes="Caster, double auto" } },
				...
				{ 7348, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="Large circular AoE inflicts Bleed" } },
				...
				{ 7357, new MobData { Threat=MobData.ThreatLevel.Danger, Aggro=MobData.AggroType.Sight, IsStunnable=false, MobNotes="Casts roomwide AoEs unaggroed\nLarge conal draw-in attack followed by heavy damage" } },
				...
				{ 7366, new MobData { Threat=MobData.ThreatLevel.Danger, Aggro=MobData.AggroType.Sight, IsStunnable=false, MobNotes="Buffs own damage unaggroed\nLarge AoE unaggroed that inflicts vuln up and stacks" } },
				{ 7367, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="Charges on aggro" } },
				{ 7368, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="Untelegraphed conal AoE on random player, gaze attack" } },
				...
				{ 7370, new MobData { Threat=MobData.ThreatLevel.Danger, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="Double autos, very strong rear cleave if behind" } },
				{ 7371, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="Alternates line and circle AoEs untelegraphed" } },
				{ 7372, new MobData { Threat=MobData.ThreatLevel.Danger, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="Buffs own damage and double autos" } },
				{ 7373, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="Draw-in attack, tons of bleed, and a stacking poison" } },
				...
				{ 7376, new MobData { Threat=MobData.ThreatLevel.Danger, Aggro=MobData.AggroType.Sight, IsStunnable=null, MobNotes="Charges, buffs own damage, double autos, electricity Bleed" } },
				...
				// HoH floors 91-99
                { 7378, new MobData { Threat=MobData.ThreatLevel.DoNotEngage, Aggro=MobData.AggroType.Sight, IsStunnable=true, MobNotes="WAR: Triple knockback with heavy damage\nBuffs own attack\nExtremely high damage cleave with knockback" } },
				...
				{ 7388, new MobData { Threat=MobData.ThreatLevel.Danger, Aggro=MobData.AggroType.Sight, IsStunnable=false, MobNotes="Charges\nUntelegraphed line AoE \"Swipe\"\nUntelegraphed wide circle AoE \"Swing\"" } },
