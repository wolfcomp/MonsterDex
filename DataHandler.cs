        ...
        private static readonly Dictionary<uint, MobData> mobs = new Dictionary<uint, MobData>()
            {
                ...
                { 7297, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sound, Vuln = new MobData.Vulnerabilities{CanStun=true}, MobNotes="Line AoE inflicts Bleed" } },
