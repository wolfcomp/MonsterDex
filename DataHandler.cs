        ...
        private static readonly Dictionary<uint, MobData> mobs = new Dictionary<uint, MobData>()
            {
                ...
                { 4977, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, Vuln = new MobData.Vulnerabilities{CanStun = true, CanBind = false, CanHeavy = false, CanSleep = false, IsUndead = false}, MobNotes="" } },
                ...
                { 4979, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, Vuln = new MobData.Vulnerabilities{CanStun = true, CanBind = true, CanHeavy = true, CanSleep = true, IsUndead = false}, MobNotes="" } },
                ...
                { 4986, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Boss, Vuln = new MobData.Vulnerabilities{CanStun = false, CanBind = false, CanHeavy = false, CanSleep = false, IsUndead = false}, MobNotes="1) \"Whipcrack\" - light tankbuster\n2) \"Stormwind\" - conal AOE\n3) \"Bombination\" - circular AOE on boss inflicts Slow\n4) \"Lumisphere\" - targeted AOE on random player\n5) \"Aeroblast\" - roomwide AOE inflicts Bleed" } },
                //PotD 11-20
                ...
                { 4999, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Boss, Vuln = new MobData.Vulnerabilities{CanStun = false, CanBind = false, CanHeavy = false, CanSleep = false, IsUndead = false}, MobNotes="1) \"Bloody Caress\" - high damage cleave\n2) Two telegraphed AOEs and a roomwide AOE\n3) Summons two hornets that must be killed before they \"Final Sting\"\n4) \"Rotten Stench\" - high damage line AOE" } },
                //PotD 21-30
                ...
                { 5012, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Boss, Vuln = new MobData.Vulnerabilities{CanStun = false, CanBind = false, CanHeavy = false, CanSleep = false, IsUndead = false}, MobNotes="1) Spread out fire and ice AOEs and don't drop them in center because: \n2) Get inside boss's hitbox for \"Fear Itself\" - will inflict high damage and Terror if not avoided" } },
                //PotD 31-40
                ...
                { 5025, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Boss, Vuln = new MobData.Vulnerabilities{CanStun = false, CanBind = false, CanHeavy = false, CanSleep = false, IsUndead = true}, MobNotes="1) Summons four lingering AoEs\n2) Summons two adds -- they must be killed before boss casts \"Scream\", adds will target player with high damage AoEs if not dead" } },
                // PotD 41-50
                ...
                { 5038, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Boss, Vuln = new MobData.Vulnerabilities{CanStun = false, CanBind = false, CanHeavy = false, CanSleep = false, IsUndead = false}, MobNotes="FOLLOW MECHANICS -- failed mechanics power up an unavoidable room AoE\nBoss will occasionally inflict Disease which slows\n1) \"In Health\" -- can be roomwide AoE with safe spot on boss or targeted AoE under boss \n2) \"Cold Feet\" -- Gaze" } },
                ...
                { 5309, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Boss, Vuln = new MobData.Vulnerabilities{CanStun = false, CanBind = false, CanHeavy = false, CanSleep = false, IsUndead = false}, MobNotes="Drops large puddle AoEs that inflict Bleed if stood in\n\"Valfodr\" -- targeted unavoidable line AoE centered on player that causes strong knockback, avoid AoEs surrounding outer edge" } },
                // PotD 61-70
                ...
                { 5321, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Boss, Vuln = new MobData.Vulnerabilities{CanStun = false, CanBind = false, CanHeavy = false, CanSleep = false, IsUndead = false}, MobNotes="\"Douse\" -- lingering ground AoE that inflicts Bleed if stood in and buffs boss with Haste if left in it\nOccasionally casts targeted ground AoEs" } },
                // PotD 71-80
                ...
                { 5345, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Boss, Vuln = new MobData.Vulnerabilities{CanStun = false, CanBind = false, CanHeavy = false, CanSleep = false, IsUndead = false}, MobNotes="Casts large AoEs\nSummons \"Grey Bomb\" - must be killed before it does high roomwide damage\nBegins long cast \"Massive Burst\" and summons \"Giddy Bomb\" that must be knocked towards the boss to interrupt cast" } },
                // PotD 91-100
                ...
                { 5356, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Boss, Vuln = new MobData.Vulnerabilities{CanStun = false, CanBind = false, CanHeavy = false, CanSleep = false, IsUndead = false}, MobNotes="Summons adds and does large targeted AoEs -- adds are vulnerable to Pomander of Resolution's attacks" } },
                // PotD 101-110
