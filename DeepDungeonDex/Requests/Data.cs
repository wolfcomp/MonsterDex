...
public partial class Requests : IDisposable
{
    ...
    private readonly Thread loadFileThread;
    private readonly Thread loadLangThread;
    ...
    public Requests(StorageHandler handler)
    {
        ...
        loadFileThread = new Thread(() => RefreshFileList());
        loadFileThread.Start();
        loadLangThread = new Thread(() => RefreshLang());
